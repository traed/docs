...
| **Available Services** | [cart](./cart-manipulation-script-services-reference#CartFacade)<br>[config](./miscellaneous-script-services-reference#SystemConfigFacade)<br>                                                                            |
| **Stoppable**          | `false`                                                                                                                                               |
