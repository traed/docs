  ...
  * [B2B Suite](products/extensions/b2b-suite.md)
    ...
    * [Guides](products/extensions/b2b-suite/guides/README.md)
      ...
      * [Core](products/extensions/b2b-suite/guides/core/README.md)
        ...
        * [Store Front Authentication](products/extensions/b2b-suite/guides/core/authentication.md)
      * [Storefront](products/extensions/b2b-suite/guides/storefront/README.md)
        ...
        * [Acl Routing](products/extensions/b2b-suite/guides/storefront/acl-routing.md)
...
* [References](resources/references/README.md)
  ...
  * [Architecture Reference](resources/references/adr/README.md)
    * [Admin](resources/references/adr/admin/README.md)
      * [Unified notification titles](resources/references/adr/admin/2020-08-21-unified-notification-titles.md)
      * [Import acl privileges from other roles](resources/references/adr/admin/2020-08-28-import-acl-privileges-from-other-roles.md)
      * [The best practice to always re fetch the data after saving](resources/references/adr/admin/2020-09-17-the-best-practice-to-always-re-fetch-the-data-after-saving.md)
      * [Introduce eslint on vue admin](resources/references/adr/admin/2021-05-28-introduce-eslint-on-vue-admin.md)
      * [Introduce jest fail on console](resources/references/adr/admin/2021-06-14-introduce-jest-fail-on-console.md)
      * [Refactor admin build process to webpack multi compiler mode](resources/references/adr/admin/2021-08-31-refactor-admin-build-process-to-webpack-multi-compiler-mode.md)
      * [Merge e2e projects into a single project](resources/references/adr/admin/2021-11-22-merge-e2e-projects-into-a-single-project.md)
      * [Add possibility for plugin to add a html file](resources/references/adr/admin/2021-11-23-add-possibility-for-plugin-to-add-a-html-file.md)
      * [Admin extension API standards](resources/references/adr/admin/2021-12-07-admin-extension-api-standards.md)
      * [Extract data handling classes to extension sdk](resources/references/adr/admin/2022-03-15-extract-data-handling-classes-to-extension-sdk.md)
      * [Providing the admin extension sdk](resources/references/adr/admin/2022-06-27-providing-the-admin-extension-sdk.md)
      * [Hide and show cms content](resources/references/adr/admin/2022-10-17-hide-and-show-cms-content.md)
    ...
    * [API](resources/references/adr/api/README.md)
      * [Implement sales channel context token requirement](resources/references/adr/api/2020-07-02-implement-sales-channel-context-token-requirement.md)
      * [Add login required annotation](resources/references/adr/api/2020-11-20-add-login-required-annotation.md)
      * [Removing API version](resources/references/adr/api/2020-12-02-removing-api-version.md)
      * [Controller configuration route defaults](resources/references/adr/api/2022-02-09-controller-configuration-route-defaults.md)
    * [App](resources/references/adr/app/README.md)
      * [Implement app system inside platform](resources/references/adr/app/2020-08-12-implement-app-system-inside-platform.md)
      * [Technical concept custom entities](resources/references/adr/app/2021-09-14-technical-concept-custom-entities.md)
      * [App scripting](resources/references/adr/app/2021-10-21-app-scripting.md)
      * [Custom app API endpoints](resources/references/adr/app/2022-01-06-custom-app-api-endpoints.md)
      * [Rule scripting in apps](resources/references/adr/app/2022-02-21-rule-scripting-in-apps.md)
      * [Integrate app into flow action](resources/references/adr/app/2022-04-19-integrate-app-into-flow-action.md)
    * [Cache](resources/references/adr/cache/README.md)
      * [Reset class state during requests](resources/references/adr/cache/2022-03-09-reset-class-state-during-requests.md)
      * [Cache stampede protection](resources/references/adr/cache/2022-03-25-cache-stampede-protection.md)
    * [Checkout](resources/references/adr/checkout/README.md)
      * [Document template refactoring](resources/references/adr/checkout/2020-08-12-document-template-refactoring.md)
      * [Merchant registration](resources/references/adr/checkout/2020-08-14-merchant-registration.md)
      * [Nested line items](resources/references/adr/checkout/2021-03-24-nested-line-items.md)
      * [Make core mail templates independent from storefront urls](resources/references/adr/checkout/2021-09-06-make-core-mail-templates-independent-from-storefront-urls.md)
      * [Payment flow](resources/references/adr/checkout/2021-10-01-payment-flow.md)
      * [Refund handling](resources/references/adr/checkout/2021-10-13-refund-handling.md)
      * [New nested line items](resources/references/adr/checkout/2022-03-17-new-nested-line-items.md)
      * [Tax providers](resources/references/adr/checkout/2022-04-28-tax-providers.md)
    * [Content-management](resources/references/adr/content-management/README.md)
      * [Blog concept](resources/references/adr/content-management/2022-07-19-blog-concept.md)
    * [DAL](resources/references/adr/dal/README.md)
      * [Control clone behavior](resources/references/adr/dal/2020-07-02-control-clone-behavior.md)
      * [DAL join filter](resources/references/adr/dal/2020-11-19-dal-join-filter.md)
      * [When to use plain sql or DAL](resources/references/adr/dal/2021-05-14-when-to-use-plain-sql-or-dal.md)
      * [Specify priority of translations in DAL write payloads](resources/references/adr/dal/2022-03-29-specify-priority-of-translations-in-dal-write-payloads.md)
    * [Deployment](resources/references/adr/deployment/README.md)
      * [Make platform stand alone](resources/references/adr/deployment/2021-08-11-make-platform-stand-alone.md)
      * [Composer based web updater](resources/references/adr/deployment/2022-11-09-composer-based-web-updater.md)
    * [Extension](resources/references/adr/extension/README.md)
    ...
    * [Performance](resources/references/adr/performance/README.md)
      * [Increment pattern](resources/references/adr/performance/2021-11-09-increment-pattern.md)
      * [Base context factory](resources/references/adr/performance/2022-03-25-base-context-factory.md)
      * [Initial state id loader](resources/references/adr/performance/2022-03-25-initial-state-id-loader.md)
      * [Prevent mail updates](resources/references/adr/performance/2022-03-25-prevent-mail-updates.md)
      * [Profiler integrations](resources/references/adr/performance/2022-03-25-profiler-integrations.md)
      * [Redis cart persister](resources/references/adr/performance/2022-03-25-redis-cart-persister.md)
    * [Rule](resources/references/adr/rule/README.md)
    ...
    * [Storefront](resources/references/adr/storefront/README.md)
      ...
      * [Deprecate csrf](resources/references/adr/storefront/2022-11-16-deprecate-csrf.md)
    ...
    * [Workflow](resources/references/adr/workflow/README.md)
      ...
      * [Feature flag system](resources/references/adr/workflow/2020-08-10-feature-flag-system.md)
